...
// src/components/sections/ConsultationCTA/ConsultationCTA.jsx
import { FaArrowRight, FaPhone, FaEnvelope, FaMapMarkerAlt, FaCalendarCheck, FaHardHat, FaClock, FaShieldAlt } from "react-icons/fa";
...
const ConsultationCTA = () => {
  return (
    <section className="fya-cta" id="start-project">
      {/* Background Image */}
      <div className="fya-cta__background">
        <img 
          src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1920&q=80" 
          alt="Construction Background"
          className="fya-cta__bg-image"
        />
        <div className="fya-cta__overlay" />
      </div>

      <div className="fya-cta__container">
        
        {/* =========================================
            TOP LABEL
        ========================================= */}
        <div className="fya-cta__header">
          <div className="fya-cta__label-wrapper">
            <span className="fya-cta__number">09</span>
            <span className="fya-cta__label">START A PROJECT</span>
            <span className="fya-cta__divider-line" />
          </div>
        </div>
        ...
        {/* =========================================
            MAIN CONTENT
        ========================================= */}
        <div className="fya-cta__content">
          <div className="fya-cta__left">
            <span className="fya-cta__badge">
              <FaHardHat className="fya-cta__badge-icon" />
              HAVE A VISION?
            </span>
            
            <h2 className="fya-cta__title">
              Let's Build
              <br />
              Something <span className="fya-cta__highlight">Lasting</span>
            </h2>
          </div>

          <div className="fya-cta__right">
            <p className="fya-cta__description">
              Whether you're planning a new home, commercial space or
              large-scale project, let's start with a conversation.
            </p>

            <div className="fya-cta__features">
              <div className="fya-cta__feature">
                <FaCalendarCheck className="fya-cta__feature-icon" />
                <span className="fya-cta__feature-text">Free Consultation</span>
              </div>
              <div className="fya-cta__feature">
                <FaClock className="fya-cta__feature-icon" />
                <span className="fya-cta__feature-text">Quick Response</span>
              </div>
              <div className="fya-cta__feature">
                <FaMapMarkerAlt className="fya-cta__feature-icon" />
                <span className="fya-cta__feature-text">On-Site Visit</span>
              </div>
              <div className="fya-cta__feature">
                <FaShieldAlt className="fya-cta__feature-icon" />
            ...
            <div className="fya-cta__actions">
              <a href="#contact" className="fya-cta__btn fya-cta__btn--primary">
                <span className="fya-cta__btn-text">Discuss Your Project</span>
                <FaArrowRight className="fya-cta__btn-icon" />
              </a>
              
              <a href="tel:+919999999999" className="fya-cta__btn fya-cta__btn--secondary">
                <FaPhone className="fya-cta__btn-icon" />
                <span className="fya-cta__btn-text">Call Now</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="fya-cta__footer">
          <div className="fya-cta__footer-item">
            <span className="fya-cta__footer-label">COMPANY</span>
            <span className="fya-cta__footer-value">FIYA BUILDERS</span>
          </div>
          
          <div className="fya-cta__footer-divider" />
          
          <div className="fya-cta__footer-item">
            <span className="fya-cta__footer-label">SERVICES</span>
            <span className="fya-cta__footer-value">CONSTRUCTION · ENGINEERING · DESIGN</span>
          </div>
          
          <div className="fya-cta__footer-divider" />
          
          <div className="fya-cta__footer-item">
            <span className="fya-cta__footer-label">LOCATION</span>
            <span className="fya-cta__footer-value">PONDICHERRY · INDIA</span>
          </div>
        </div>
