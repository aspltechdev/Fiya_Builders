...
import { getActiveHeroes } from "../../services/hero.api";
...
const HeroSection = () => {
  ...
  */
  ...
  const title =
    hero?.title ||
    "Building Excellence That Endures";
  ...
  const description =
    hero?.description ||
    "We craft spaces with precision, innovation, and unwavering commitment to quality.";
  ...
  */
  ...
  return (
    ...
    >
      ...
      <div
        className="fya-hero-cinematic__media"
        key={hero?.id || activeIndex}
      >
      ...
      <div className="fya-hero-cinematic__container">
        ...
        <div className="fya-hero-cinematic__content">
          ...
          <div className="fya-hero-cinematic__badge animate-fade-in-up">
            ...
            <span className="fya-hero-cinematic__badge-text">
              Trusted Since 2014
            </span>
          ...
          <div
            className="fya-hero-cinematic__subtitle animate-fade-in-up"
            style={{
              animationDelay: "0.2s",
            }}
          >
          ...
          <h1
            className="fya-hero-cinematic__title animate-fade-in-up"
            style={{
              animationDelay: "0.3s",
            }}
          >
              ...
              (word, index) => {
                ...
                return (
                  ...
                  <span
                    ...
                    className={`fya-hero-cinematic__title-word ${
                      isHighlight
                        ? "highlight"
                        : ""
                    }`}
          ...
          <p
            className="fya-hero-cinematic__description animate-fade-in-up"
            style={{
              animationDelay: "0.6s",
            }}
          >
          ...
          <div
            className="fya-hero-cinematic__actions animate-fade-in-up"
            style={{
              animationDelay: "0.8s",
            }}
          >
            ...
            <a
              href={buttonLink}
              className="fya-hero-cinematic__btn-primary"
            >
            ...
            <a
              href="/contact"
              className="fya-hero-cinematic__btn-secondary"
            >
          ...
          <div
            className="fya-hero-cinematic__stats animate-fade-in-up"
            style={{
              animationDelay: "1s",
            }}
          >
            ...
            <div className="fya-hero-cinematic__stat">
              ...
              <span className="fya-hero-cinematic__stat-label">
                Projects Completed
              </span>
        ...
        <div
          className="fya-hero-cinematic__bottom animate-fade-in-up"
          style={{
            animationDelay: "1.2s",
          }}
        >
          ...
          <div className="fya-hero-cinematic__scroll">
            ...
            <span className="fya-hero-cinematic__scroll-text">
              Scroll to explore
            </span>
          ...
          <div className="fya-hero-cinematic__location">
            ...
            <div className="fya-hero-cinematic__location-text">
              ...
              <span className="fya-hero-cinematic__location-label">
                Based in
              </span>

              <span className="fya-hero-cinematic__location-value">
                Pondicherry, India
              </span>
          ...
          <div className="fya-hero-cinematic__index">
            ...
            <button
              type="button"
              className="fya-hero-cinematic__index-arrow"
            ...
            <span className="fya-hero-cinematic__index-current">
            ...
            <span className="fya-hero-cinematic__index-line">
              ...
              <span
                className="fya-hero-cinematic__index-progress"
                style={{
                  width:
                    heroes.length > 0
                      ? `${
            ...
            <span className="fya-hero-cinematic__index-total">
